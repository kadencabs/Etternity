...
set_directory_properties(PROPERTIES VS_STARTUP_PROJECT Etternity)
...
set_target_properties(Etternity PROPERTIES RUNTIME_OUTPUT_DIRECTORY "$<1:${PROJECT_SOURCE_DIR}/Program>")

# Universal Build Options
set_target_properties(Etternity PROPERTIES
...
set_source_files_properties(src/Etternity/Singletons/NetworkSyncManager.cpp PROPERTIES COMPILE_FLAGS /bigobj)

# Ignore the safer function variants provided by VC++. They are not portable.
target_compile_definitions(Etternity PRIVATE _CRT_SECURE_NO_WARNINGS)

# Linking - Windows Only
target_link_libraries(Etternity PUBLIC ffmpeg)

find_package(DirectX REQUIRED)
get_filename_component(DIRECTX_LIBRARY_DIR "${DIRECTX_LIBRARIES}" DIRECTORY)
target_link_directories(Etternity PUBLIC ${DIRECTX_LIBRARY_DIR})
target_include_directories(Etternity PRIVATE ${DIRECTX_INCLUDE_DIR})
...
target_compile_definitions(Etternity PRIVATE $<$<CONFIG:RelWithDebInfo>:RELWITHDEBINFO>)