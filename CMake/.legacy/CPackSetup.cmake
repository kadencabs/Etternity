...
set(CPACK_PACKAGE_VENDOR "Etternity")
...
set(CPACK_NSIS_HELP_LINK "https://github.com/etternitygame/etternity/issues")
set(CPACK_NSIS_PACKAGE_NAME "${SM_EXE_NAME} ${NSIS_VERSION_FINAL}")
set(CPACK_NSIS_URL_INFO_ABOUT "https://etternityonline.com/")
...
set(CPACK_PACKAGE_EXECUTABLES
  "${SM_EXE_NAME}" "Etternity ${SM_VERSION_MAJOR}" 
)
...
set(CPACK_SM_NSIS_REPOSITORY "https://github.com/etternitygame/etternity/")
set(CPACK_SM_NSIS_ROOT_DIR "${SM_ROOT_DIR}")
set(CPACK_SM_NSIS_PRODUCT_ID "Etternity ${SM_VERSION_MAJOR}.${SM_VERSION_MINOR}")
...
if(WIN32)
  ...
  # The default directory of "Etternity major.minor.patch" is lost.
  # This is currently done to maintain backwards compatibility.
  # However, removing these two will allow for multiple versions of Etternity
  # to be installed relatively cleanly.
  set(CPACK_PACKAGE_INSTALL_DIRECTORY "Etternity ${SM_VERSION_MAJOR}")
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "Etternity ${SM_VERSION_MAJOR}")
