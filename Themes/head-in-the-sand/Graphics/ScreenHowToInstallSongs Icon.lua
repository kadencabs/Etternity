...
local t = Def.ActorFrame{
	...
	InitCommand=function(self)
		self:x(SCREEN_CENTER_X*1.5):y(SCREEN_CENTER_Y*0.85)
	end;
	OffCommand=function(self)
		self:bouncebegin(0.25):addx(SCREEN_CENTER_X)
	end;
};
...
local function TitleMenuItem(text,focused)
	...
	return LoadFont("Common Normal")..{
		Text=text;
		InitCommand=function(self)
			self:zoom(0.45):strokecolor(Color("Outline")):diffuse(textColor)
		end;
		GainFocusCommand=function(self)
			self:stoptweening():decelerate(0.5):diffusealpha(1)
		end;
		LoseFocusCommand=function(self)
			self:stoptweening():accelerate(0.5):diffusealpha(0)
		end;
	};
end;
...
local previews = {
	...
	AdditionalFolders = Def.ActorFrame{
		...
		Def.Quad{
			InitCommand=function(self)
				self:y(-previewHeight*0.45):diffuse(color("#E0F0F0")):zoomto(previewWidth,previewHeight*0.1)
			end;
			GainFocusCommand=function(self)
				self:stoptweening():decelerate(0.5):diffusealpha(1)
			end;
		...
		LoadFont("Common normal")..{
			InitCommand=function(self)
				self:x(-(SCREEN_CENTER_X*0.4)):y(-(SCREEN_CENTER_Y*0.475)):zoom(0.625):halign(0):valign(0):diffuse(color("#000000"))
			end;
		...
		LoadFont("Common normal")..{
			...
			InitCommand=function(self)
				self:x(-(SCREEN_CENTER_X*0.4)):y(-(SCREEN_CENTER_Y*0.35)):zoom(0.75):halign(0):valign(0):diffuse(color("#000000"))
			end;
			GainFocusCommand=function(self)
				self:stoptweening():decelerate(0.5):diffusealpha(1)
			end;
	...
	ReloadSongs = Def.ActorFrame{
		LoadActor(THEME:GetPathB("ScreenTitleMenu","background/_bg"))..{
			InitCommand=function(self)
				self:zoomto(previewWidth,previewHeight):halign(0.5):valign(0.5)
			end;
			GainFocusCommand=function(self)
				self:stoptweening():decelerate(0.5):diffusealpha(1)
			end;
		...
		LoadFont("Common normal")..{
			InitCommand=function(self)
				self:zoom(0.4):maxwidth((previewWidth*1.6)-8)
			end;
			BeginCommand=function(self)
	...
	Exit = Def.ActorFrame{
		...
		LoadActor(THEME:GetPathG("ScreenTitleMenu","logo"))..{
			InitCommand=function(self)
				self:y(-28):zoom(0.35):propagate(true)
			end;
			GainFocusCommand=function(self)
				self:stoptweening():decelerate(0.5):diffusealpha(1)
			end;
...
t[#t+1] = LoadFont("Common normal")..{
	...
	InitCommand=function(self)
		self:x(-(SCREEN_CENTER_X*0.8)):y(SCREEN_CENTER_Y*0.8):halign(0):valign(0):zoom(0.65):wrapwidthpixels((SCREEN_WIDTH*0.55)*1.75):NoStroke():shadowlength(1)
	end;
	GainFocusCommand=function(self)
		self:stoptweening():decelerate(0.5):diffusealpha(1)
	end;
