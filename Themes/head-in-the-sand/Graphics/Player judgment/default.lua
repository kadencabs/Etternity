...
t[#t+1] = Def.ActorFrame {
	...
	Def.Quad {
		...
		InitCommand=function(self)
			self:visible(false):y(32):zoomto(ProtimingWidth,16)
		end;
		ResetCommand=function(self)
			self:finishtweening():diffusealpha(0.8):visible(false)
		end;
		OnCommand=function(self)
			self:diffuse(Color("Black")):diffusetopedge(color("0.1,0.1,0.1,1")):diffusealpha(0.8):shadowlength(2)
		end;
	};
	Def.Quad {
		Name="ProtimingGraphWindowW3";
		InitCommand=function(self)
			self:visible(false):y(32):zoomto(ProtimingWidth-4,16-4)
		end;
		ResetCommand=function(self)
			self:finishtweening():diffusealpha(1):visible(false)
		end;
		OnCommand=function(self)
	...
	Def.Quad {
		...
		InitCommand=function(self)
			self:visible(false):y(32):zoomto(scale(PREFSMAN:GetPreference("TimingWindowSecondsW2"),0,PREFSMAN:GetPreference("TimingWindowSecondsW3"),0,ProtimingWidth-4),16-4)
		end;
		ResetCommand=function(self)
			self:finishtweening():diffusealpha(1):visible(false)
		end;
	...
	Def.Quad {
		...
		InitCommand=function(self)
			self:visible(false):y(32):zoomto(scale(PREFSMAN:GetPreference("TimingWindowSecondsW1"),0,PREFSMAN:GetPreference("TimingWindowSecondsW3"),0,ProtimingWidth-4),16-4)
		end;
		ResetCommand=function(self)
			self:finishtweening():diffusealpha(1):visible(false)
		end;
	...
	Def.Quad {
		...
		ResetCommand=function(self)
			self:finishtweening():diffusealpha(0.25):visible(false)
		end;
		OnCommand=function(self)
	...
	Def.Quad {
		...
		InitCommand=function(self)
			self:visible(false):y(32):zoomto(0,16-4):horizalign(left)
		end;
		ResetCommand=function(self)
			self:finishtweening():diffusealpha(1):visible(false)
		end;
	...
	Def.Quad {
		...
		InitCommand=function(self)
			self:visible(false):y(32):zoomto(2,7)
		end;
		ResetCommand=function(self)
			self:finishtweening():diffusealpha(0.85):visible(false)
		end;
		OnCommand=function(self)
			self:diffuse(Color("Orange")):diffusealpha(0.85)
		end;
	};
	Def.Quad {
		Name="ProtimingGraphCenter";
		InitCommand=function(self)
			self:visible(false):y(32):zoomto(2,16-4)
		end;
		ResetCommand=function(self)
			self:finishtweening():diffusealpha(1):visible(false)
		end;
		OnCommand=function(self)
			self:diffuse(Color("White")):diffusealpha(1)
		end;
	};
	InitCommand = function(self)
		c = self:GetChildren();
