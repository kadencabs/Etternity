...
local t = Def.ActorFrame{
	BeginCommand=function(self)
		self:playcommand("SetIcons"):playcommand("SetAttacksIconMessage")
	end;
	...
	LoadActor(iconPath)..{
		...
		InitCommand=function(self)
			self:animate(false):x(SegmentTypes.Warps.xPos):y(SegmentTypes.Warps.yPos):setstate(SegmentTypes.Warps.Frame):diffusealpha(0)
		end;
		ShowCommand=showCmd;
		HideCommand=hideCmd;
	};
	LoadActor(iconPath)..{
		Name="StopsIcon";
		InitCommand=function(self)
			self:animate(false):x(SegmentTypes.Stops.xPos):y(SegmentTypes.Stops.yPos):setstate(SegmentTypes.Stops.Frame):diffusealpha(0)
		end;
		ShowCommand=showCmd;
		HideCommand=hideCmd;
	};
	LoadActor(iconPath)..{
		Name="DelaysIcon";
		InitCommand=function(self)
			self:animate(false):x(SegmentTypes.Delays.xPos):y(SegmentTypes.Delays.yPos):setstate(SegmentTypes.Delays.Frame):diffusealpha(0)
		end;
		ShowCommand=showCmd;
		HideCommand=hideCmd;
	};
	LoadActor(iconPath)..{
		Name="AttacksIcon";
		InitCommand=function(self)
			self:animate(false):x(SegmentTypes.Attacks.xPos):y(SegmentTypes.Attacks.yPos):setstate(SegmentTypes.Attacks.Frame):diffusealpha(0)
		end;
		ShowCommand=showCmd;
		HideCommand=hideCmd;
	};
	LoadActor(iconPath)..{
		Name="ScrollsIcon";
		InitCommand=function(self)
			self:animate(false):x(SegmentTypes.Scrolls.xPos):y(SegmentTypes.Scrolls.yPos):setstate(SegmentTypes.Scrolls.Frame):diffusealpha(0)
		end;
		ShowCommand=showCmd;
		HideCommand=hideCmd;
	};
	LoadActor(iconPath)..{
		Name="SpeedsIcon";
		InitCommand=function(self)
			self:animate(false):x(SegmentTypes.Speeds.xPos):y(SegmentTypes.Speeds.yPos):setstate(SegmentTypes.Speeds.Frame):diffusealpha(0)
		end;
		ShowCommand=showCmd;
		HideCommand=hideCmd;
	};
	LoadActor(iconPath)..{
		Name="FakesIcon";
		InitCommand=function(self)
			self:animate(false):x(SegmentTypes.Fakes.xPos):y(SegmentTypes.Fakes.yPos):setstate(SegmentTypes.Fakes.Frame):diffusealpha(0)
		end;
		ShowCommand=showCmd;
		HideCommand=hideCmd;
	};
