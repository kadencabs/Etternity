...
local function LoadPlayerStuff(Player)
	...
	t[#t + 1] = Def.ActorFrame {
		Name = "BigFrame",
		LoadCard(Brightness(color("#ffffaa"), 0.3)),
	}
	t[#t + 1] = Def.ActorFrame {
		Name = "SmallFrame",
		InitCommand = function(self)
...
t[#t + 1] = LoadFont("Common Large") .. {
	InitCommand = function(self)
		self:xy(5, 32):halign(0):valign(1):zoom(0.55):diffuse(color("#ffffff"))
...
t[#t+1] = LoadFont("Common Large") .. {
	InitCommand = function(self)
		...
		self:halign(0):valign(0):zoom(0.35):diffuse(color("#ffffff"))
