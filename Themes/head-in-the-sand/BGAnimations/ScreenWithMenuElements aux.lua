local function Clock()
	...
	clock = Def.ActorFrame {
		...
		InitCommand=function(self)
			self:x(50):y(12):playcommand("Update")
		end,
		...
		Def.ActorFrame {
			...
			LoadFont("Common", "normal")..{
				Text="00:00:",
				InitCommand=function(self)
					self:horizalign(right):shadowlength(0):diffusebottomedge(color("0.9,0.9,0.9"))
				end,
			...
			LoadFont("Common", "normal")..{
				Text="00",
				InitCommand=function(self)
					self:horizalign(left):shadowlength(0):diffusebottomedge(color("0.9,0.9,0.9"))
				end,
				UpdateCommand=function(self)
					local sec = Second()
			...
			LoadFont("Common", "normal")..{
				Text="",
				InitCommand=function(self)
					self:x(28):y(-3):horizalign(left):shadowlength(0):diffusebottomedge(color("0.9,0.9,0.9")):visible(false):zoom(0.75)
				end,
				UpdateCommand=function(self)
