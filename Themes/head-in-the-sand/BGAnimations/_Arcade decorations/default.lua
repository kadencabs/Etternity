...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor(THEME:GetPathG("OptionRowExit","Frame")) .. {
		InitCommand=function(self)
			self:diffuse(Color("Orange")):diffusealpha(0.35)
		end;
	};
	LoadFont("Common Normal") .. {
		InitCommand=function(self)
			self:zoom(0.75):shadowlength(1):glowshift():strokecolor(Color("Outline")):diffuse(Color("Orange")):diffusetopedge(Color("Yellow")):textglowmode('TextGlowMode_Inner')
		end;
		Text="...";
