local t = Def.ActorFrame{
	...
	Def.Quad{
		Name="BotFrame";
		InitCommand=function(self)
			self:CenterX():y(SCREEN_BOTTOM):valign(1):zoomto(SCREEN_WIDTH,SCREEN_HEIGHT*0.15):diffuse(color("0,0,0,1")):fadetop(0.5)
		end;
	};
	...
	LoadFont("Common normal")..{
		Name="SongTitle";
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_TOP+16):zoom(0.5):shadowlength(1):valign(0)
		end;
