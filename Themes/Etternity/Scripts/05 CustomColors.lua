--- Etternity: Custom Colors Storage System
...
if create_setting then
	customColorConfig = create_setting("HVCustomColors", "Etternity_customColors.lua", defaultCustomColors, -1)
else
...
local function initCustomColors()
	...
	if customColorConfig and customColorConfig.get_data then
		...
		local path = "Save/Etternity_settings/HVCustomColors.lua"
...
Trace("Etternity: 05 CustomColors.lua loaded.")
