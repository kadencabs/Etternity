...
local t = Def.ActorFrame {
	LoadActor(THEME:GetPathB("_frame","3x1"),"rounded light", 250-16) .. {
		OnCommand=function(self) self:diffuse(ColorLightTone(PlayerColor(PlayerNumber))):diffusealpha(0.8) end;
	};
	...
	LoadFont("_overpass 36px") .. {
		...
		BPMWillChangeCommand=function(self) self:diffuseshift():effectcolor1(Color.Black):effectcolor2(ColorMidTone(PlayerColor(PlayerNumber))) end,
