...
--[[ 			Def.Quad {
			...
			LoadFont("Common Fallback") .. {
				...
				InitCommand=function(self) self:shadowlength(1):y(-12):zoom(1):strokecolor(color("#000000")):ztest(true) end;
			};
...
--[[ 		Def.Quad {
		...
		LoadFont("Common Italic Condensed") .. {
			...
			InitCommand=function(self) self:shadowlength(1):zoom(1.25) end;
	...
	t[#t+1] = Def.ActorScroller{
		Name = 'Scroller';
		NumItemsToDraw=6;
 		--InitCommand=function(self) self:zoom(2) end;
...
-- 			self:zoom(focus);
	...
	t[#t+1] = LoadFont("Common Fallback") .. {
		...
		InitCommand=function(self) self:y(160):shadowlength(1):diffuse(color("#FFFFFF")):strokecolor(ColorDarkTone(PlayerColor(Player))):diffusebottomedge(color("#FFFFFF")):zoom(1.25) end;
	};
