...
--[[ local function PlayerPane( PlayerNumber ) 
	...
	t[#t+1] = Def.ActorFrame {
		Name = "Background";
		Def.Quad {
			InitCommand=function(self) self:zoomto(160,28):queuecommand("On") end;
			OnCommand=function(self) self:diffuse(PlayerColor(PlayerNumber)):fadebottom(1) end;
		};
	};
	t[#t+1] = Def.BitmapText{
		Font="Common Normal";
		Name = "PlayerText";
		InitCommand=function(self) self:x(-60):maxwidth(80/0.5):zoom(0.5):queuecommand("On") end;
...
t[#t+1] = Def.ActorFrame {
--[[  	PlayerPane( PLAYER_1 ) .. {
		InitCommand=function(self) self:x(scale(0.125,0,1,SCREEN_LEFT,SCREEN_WIDTH)):y(SCREEN_BOTTOM-16) end
	}; --]]
