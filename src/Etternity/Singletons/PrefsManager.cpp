...
PrefsManager::PrefsManager()
  ...
  , m_sDefaultModifiers("DefaultModifiers", "Reverse")
  ...
  , m_iMaxTextureResolution("MaxTextureResolution", 8192)
  ...
  , m_bShrinkSongCache("RemoveCacheEntriesForDeletedSongs", true)
  ...
  , m_fBGBrightness("BGBrightness", 0.0f)
  , m_bShowBackgrounds("ShowBackgrounds", false)

  , m_bDelayedBack("DelayedBack", false)
  , m_AllowStartToGiveUp("AllowStartToGiveUp", false)
  ...
  , m_iMusicWheelSwitchSpeed("MusicWheelSwitchSpeed", 25)
  ...
  , m_bForceNoDoubleSetup("ForceNoDoubleSetup", true)
  ...
  , m_sDefaultTheme("DefaultTheme", "Main")
